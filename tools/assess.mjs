...
const c=await api('/api/changes',{kind:'assessment',title:process.env.CG_QUESTION??'Assess recent deployment risk and dependency failures',sector:process.env.CG_SECTOR??'retail',bundle});
